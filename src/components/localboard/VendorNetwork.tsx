        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          <div className="lg:col-span-2">
            ...
            <h2 className="mt-4 font-display text-4xl md:text-5xl tracking-tight text-balance">
              A new ad network made of real local spaces.
            </h2>
            <p className="mt-4 text-lg font-light text-muted-foreground">
              LocalBoard can turn cafes, gyms, salons, coworking spaces, apartments, restaurants,
              and local venues into measurable ad placements.
            </p>
            <a
              href="/agent-run"
